        ...
        <div class="card radius-10">
            <div class="card-header bg-transparent">
                <div class="d-flex align-items-center">
                    <div>
                        {{-- <h6 class="mb-0"><a href="{{ route('cetak.fine') }}" class="btn btn-primary">Cetak Pdf</a>
                        </h6> --}}
                    </div>
                    <div class="dropdown ms-auto">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('cetak.loan') }}" target="_blank">Cetak Pdf</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('cetak.loan.excel') }}">Cetak Excel</a>
                            </li>
                            <li>
...
$(document).ready(function () {
    $('#fine-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("report.loan") }}', // Sesuaikan dengan route kamu
        columns: [
