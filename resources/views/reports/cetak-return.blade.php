    ...
    <section class="content">
        <div class="container-fluid">
            <div class="receipt">
                ...
                <h6 class="fw-bold mb-3">Laporan Semua Pengembalian</h6>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($return->loan_date)->translatedFormat('d F Y') }}</td>
                                <td>{{ \Carbon\Carbon::parse($return->due_date)->translatedFormat('d F Y') }}</td>
                                <td>{{ \Carbon\Carbon::parse($return->return_date)->translatedFormat('d F Y') }}</td>
                                <td>{{ $return->status === 'returned' ? 'Dikembalikan' : $return->status }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div><strong>Status Peminjaman:</strong> <span class="text-success">{{ $item->status === 'returned' ? 'Dikembalikan' : $item->status }}<span></div>
                        @endforeach
                    </div>
