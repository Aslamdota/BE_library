    ...
    <section class="content">
        <div class="container-fluid">
            <div class="receipt">
                ...
                <h6 class="fw-bold mb-3">Laporan Semua Peminjaman</h6>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($loan->due_date)->translatedFormat('d F Y') }}</td>
                                <td>{{ $loan->status === 'borrowed' ? 'Dipinjam' : $loan->status }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div><strong>Status Peminjaman:</strong> <span class="text-success">{{ $item->status === 'borrowed' ? 'Dipinjam' : $item->status }}<span></div>
                        @endforeach
                    </div>
